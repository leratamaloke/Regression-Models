...
If we have more observations available, with same cars model, using manual and automatic transmission, could help us better answer the second question about: Quantify the MPG difference between automatic and manual transmissions? The database with only 32 observations may not have been enough to answer more clearly the second question.
